...
const Footer = () => {
  return (
    <footer className="border-t border-[#2a2f36] bg-[#070b10] text-white">
      <div className="mx-auto flex w-full max-w-360 items-center justify-between gap-4 px-3 py-4 sm:px-5 lg:px-8">
